														...
														<table style="float:left;width:100%;padding-left:0px;margin-top:0px;">
															<tr>
																<td>
																	<div class="input text">
																		<label class="setting" data-setting="title">
																			<span><?php _e('Provide URL to the snapshot image'); ?></span>
																...
																<td style="width:125px;vertical-align:top;">
																	...
																	<div class="bridBrowseLibary btnMargin" data-field="VideoImage" data-uploader_button_text="Add Snapshot" data-uploader_title="Browse for Snapshot image"><?php _e('BROWSE LIBRARY'); ?></div>
																</td>
															</tr>
														</table>
													</td>
...
<?php /* if (!$upload) { ?>
	<div id="addVideoQuestion" style="position:absolute; bottom:0px;" data-action="askQuestion" href="<?php echo admin_url('admin-ajax.php') . '?action=askQuestion'; ?>"><?php _e('Want us to host and encode videos for you? Upgrade to premium plan'); ?>.</div>
	<script>
...
<script>
	...
	function saveVideo(e) {
		...
		debug.log('saveVideo from add_video.php');
	...
	if (browse.length > 0) {
		browse.on('click', function() {
			...
			//serach of wp media not working if colorbox is visible
			jQuery('#colorbox').css('display', 'none');

			// Finally, open the modal
			file_frame.open();

			//on wp media close show again colorobox element
