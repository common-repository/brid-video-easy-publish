<div class="mainWrapper mainWrap" style='padding-top:10px;'>
	<div class="videos form">
		<form action="<?php echo admin_url('admin-ajax.php'); ?>" data-redirect="/videos/index" id="VideoAddForm" method="post" accept-charset="utf-8">
								...
								<div id="mainAdd">
									...
									<div class="mainDataAdd" id="externalForm">
										...
										<div style="padding:0px;position:relative" id="youtubeSearch">
											...
											<div class="input text"><input name="youtube_search" default-value="Enter video URL" data-info="Search for a term or enter video URL" type="text" id="VideoYoutubeSearch" data-ajax-loaded="true">

											</div>
										</div>
										<div class="msgAdBox" style="position:relative; top: -10px;">
											<?php _e('By clicking "ADD" you confirm that you own all copyrights in this video or have authorization to upload and use it.'); ?>
										</div>
										<!-- YOUTUBE CHANNELS -->
												...
												<tr>
													<td colspan="2">
														...
														<div class="input text">
															...
															<div class="defaultInputValue defaultValueIndent" style="padding-top: 0px; display: block; top: 14px; padding-left: 5px; font-size: 16px;" id="default-value-VideoTags" data-position="true"><?php _e('Tags'); ?></div>
														</div>
													</td>
					...
					<td class="videoTitleTable">
						<div style="float:left;width:100%;">
							...
							<div class="videoUploadedBy">
								<div class="siteVideosNum">{{#if author}}By: {{author}} &nbsp;&nbsp;{{/if}}<span style="color:#b5b5b5"><?php _e('Published'); ?>: {{published}}</span></div>
							</div>
							<div>
	...
	var populateDataAndSave = function(youtubeUrl, dataId) { //Check Youtube/Vimeo Url
		...
		jQuery.ajax({
			...
			if (typeof responseData == 'object' && responseData.length != 0) {
				debug.log('add_yt populateDataAndSAve:', responseData, 'id:', this.id);
