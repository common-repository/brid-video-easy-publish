...
<div class="media-frame wp-core-ui" id="__wp-uploader-id-12822828287780">
	<div class="media-frame-menu">
		<div class="media-menu">
			...
			<?php if ($user['permissions']['carousel'] && !BridOptions::getOption('hide_manage_carousels')) : ?>
				<a href="#" class="media-menu-item media-brid-action active" data-action="carousel_library"><?php _e('Manage carousels'); ?></a>
			<?php endif; ?>
	...
	<div class="media-frame-router">
		<div class="media-router">
			<a href="#" data-id="carouselLibraryPost" class="media-menu-item active"><?php _e('Carousel Library'); ?></a>
		</div>
	</div>
	...
	<div class="media-frame-content" id="brid-content">
		<?php echo BridQuickPost::addCarouselPost(true); ?>
	</div>
			...
			<div class="media-toolbar-primary">
				<div class="mainWrapper" style="padding-top: 0px ;width: auto">
					<div class="bridButton disabled" data-redirect="off" data-colorbox-close="0" id="updateBridItem" data-method="onUnitUpdate" data-form-bind="0" data-form-req="0" style="position: absolute; right: 120px; top: 5px; display:none;">
						<div class="buttonLargeContent" id="carouselSaveAddText"><?php _e('UPDATE'); ?></div>
					</div>
					<div class="bridButton saveButton" id="carouselSaveAdd" data-method="onCarouselSave" data-form-bind="0" data-form-req="0" style="position: absolute; right: 20px; top: 5px;">

						<div class="buttonLargeContent" id="carouselSaveAddText"><?= $button; ?></div>
					</div>
				</div>
			</div>
		</div>
